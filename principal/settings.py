...
SECRET_KEY = 'django-insecure-9mq^w1dq^1lef@mcly4+&ie&xn5r2**a%&90y9lhx(ugctb*h0'
...
INSTALLED_APPS = [
    ...
    # pip install django-select2 pip install django-redis
    'usuarios',
    'ciudades',
    'guia',
    'clientes',
