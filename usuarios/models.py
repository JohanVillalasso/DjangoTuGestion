...
class PuntoVenta(models.Model):
  ...
  cod_CiudDANE = models.ForeignKey(Ciudad, on_delete=models.CASCADE, null=True, blank=False, related_name='CiudadPVenta')    
...
class Usuario(models.Model):
  ...
  pto_venta = models.ForeignKey(PuntoVenta, on_delete=models.CASCADE, null=True, blank=False,  related_name='UsuarioPVenta')   
